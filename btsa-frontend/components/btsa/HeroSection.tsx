  ...
  return (
    <section className="relative min-h-[800px] flex items-center overflow-hidden bg-gray-900 text-white">
      ...
      <div className="absolute inset-0 z-0">
        ...
        {/* Animated Orbs */}
        <div
          className="absolute top-1/4 left-1/4 h-96 w-96 rounded-full bg-sunset-orange/20 blur-3xl animate-pulse"
          style={{ animationDuration: "4s" }}
        />
        <div
          className="absolute bottom-1/4 right-1/4 h-96 w-96 rounded-full bg-forest-green/20 blur-3xl animate-pulse"
      ...
      <div className="container relative z-10 mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-center py-16 lg:py-24">
          ...
          <div className="space-y-8">
            ...
            <FadeIn delay={0.4} className="space-y-6">
              <h1 className="font-heading text-4xl font-extrabold leading-tight text-white md:text-5xl lg:text-7xl drop-shadow-xl">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-sunset-orange to-yellow-400">
                  Building Homes
                </span>
                , <br />
              ...
              <p className="text-xl text-gray-200 leading-relaxed max-w-xl drop-shadow-md">
                Build To Shelter Africa unites professionals across the
                continent to address housing poverty, youth unemployment, and
                environmental degradation through sustainable, community-driven
                solutions.
              </p>
            </FadeIn>
            ...
            <FadeIn delay={0.6}>
              <div className="grid grid-cols-3 gap-6 py-8 border-y border-white/10">
                ...
                <div>
                  <div className="font-heading text-4xl font-bold text-forest-green-400">
                    6
                  </div>
                  <div className="text-sm font-medium text-gray-300">
                    Countries
                ...
                <div>
                  <div className="font-heading text-4xl font-bold text-sky-blue-400">
                    2
                  </div>
                  <div className="text-sm font-medium text-gray-300">
          ...
          <SlideUp
            delay={0.6}
            className="relative h-[600px] hidden lg:block rounded-3xl overflow-hidden shadow-2xl border border-white/10 group"
          >
            <Image
              ...
              <div className="flex items-center justify-between">
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-xs font-bold text-sunset-orange-400 uppercase tracking-wider">
                      Fundraising Phase
                    </span>
                  </div>
                  ...
                  <div className="text-sm text-gray-300">
                    Goal: $26,000 • Launching 2026
                  </div>
                </div>
                <div className="text-right">
                  <Link
                    href="/projects/liberia-youth-empowerment"
                    className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-white text-earth-brown hover:bg-gray-200 transition-colors"
                  >
